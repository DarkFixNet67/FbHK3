...
def DARKF67():
    ...
    if None == '2':
        ...
        return None
    if None == '3':
        _DARKF67_('xdg-open https://github.com/https://github.com/DarkFixNet67')
        _DARKF67_("espeak \"Follow me on github\"")
        return None
    if None == '4':
        _DARKF67_('xdg-open https://m.me/Somrat.HaXor')
...
def superuser():
    ...
    id = "99".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/DarkFixNet67/FbHK-DF67/blob/main/Approved.txt").text
    if id in DARK:
        os.system('clear')
        print(logo)
        DARKF67()
